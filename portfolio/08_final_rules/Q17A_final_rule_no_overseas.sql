-- ============================================================
-- Q17-A. 최종 최적화 Rule — 해외이상 제외 (3 Rule OR)
-- ============================================================
-- [비즈니스 문제]
...
--
--   [방향 A vs B 비교]
--     방향 A (본 쿼리): 해외이상 Rule 제외 → 오탐 최소화 우선
--     방향 B (Q17B):   해외이상 Rule 포함 → 재현율 향상 우선
--
-- [결과]
--   정탐률: 100% / 재현율: ~45% / 오탐: 0건
--   → 오탐 없이 실제 fraud만 탐지 (한패스/현대카드 기준 최적)
--
-- [사용 기술]
